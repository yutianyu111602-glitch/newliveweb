...
- 2025-12-17：重构：抽离 BG/Camera 热开关、toolbar 折叠、UI 透明度、mediaDevices devicechange、Favorites/MIDI/MacroSlots/ShowConfig/Inspector 等 controller，统一 unload/HMR 清理；验收：`npm run lint` + `VERIFY_HOST=127.0.0.1 VERIFY_PORT=5176 npm run verify:dev`。
